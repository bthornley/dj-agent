...
export default function BookingDashboard({ events, loading, refreshEvents }: BookingDashboardProps) {
    ...
    return (
        <div className="booking-dashboard-component">
            <div className="section-header">
                <div>
                    ...
                    <p className="section-subtitle">
                        Manage inquiries, draft proposals, and bookings
                    </p>
                </div>
            ...
            {loading ? (
                ...
                <div className="empty-state">
                    ...
                    <h3>No events yet</h3>
                    <p>Start by <Link href="/leads/scan" style={{ color: 'var(--accent-primary)' }}>scanning for leads</Link> and hand them off to create events.</p>
                </div>
            ) : viewMode === 'list' ? (
                <div className="event-list">
                    {events.map(event => {
